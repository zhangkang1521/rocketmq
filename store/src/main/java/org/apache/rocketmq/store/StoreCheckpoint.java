...
public class StoreCheckpoint {
    ...
    private volatile long physicMsgTimestamp = 0; // commitLog 刷盘时间
    private volatile long logicsMsgTimestamp = 0; // 队列刷盘时间
    private volatile long indexMsgTimestamp = 0; // 索引刷盘时间
